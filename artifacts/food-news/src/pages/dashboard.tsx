...
import { RefreshCw, Search, ExternalLink, Calendar, Filter, FileText, Globe, Layers, AlertTriangle, Clock, Bell, BellOff, Sheet, CheckCircle2, XCircle, Upload, Settings, BarChart2 } from "lucide-react";
...
export default function Dashboard() {
  ...
  const [mainTab, setMainTab] = useState<"news" | "markets">("news");
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-1 bg-muted/30 border border-border rounded-lg p-1">
            <button
              ...
              className={`flex items-center gap-2 px-4 py-1.5 rounded-md text-sm font-medium transition-colors ${mainTab === "news" ? "bg-primary/20 text-primary" : "text-muted-foreground hover:text-foreground"}`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-1.5 rounded-md text-sm font-medium transition-colors ${mainTab === "markets" ? "bg-primary/20 text-primary" : "text-muted-foreground hover:text-foreground"}`}
            >
